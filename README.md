...
### `Software Developer` • `Artificial Intelligence` • `Machine Learning` • `Cybersecurity`
...
### 🖥️ AI Virtual IT Support Agent

AI-powered IT support and troubleshooting platform.
...
AI-powered competency and skill-gap tracking system.
...
### 🌍 Visit Kirehe Tourism

Tourism-focused web platform.
